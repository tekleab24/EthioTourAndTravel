    ...
    return GetBuilder<ToursiteControler>(
        ...
        builder: (controller) {
          if (controller.is_loaading.value) {
            ...
            return controller.toursites.value.isEmpty
                    ...
                    child: CarouselSlider.builder(
                      ...
                      itemBuilder: (BuildContext context, int itemIndex,
                        ...
                        child: GestureDetector(
                          onTap: () =>
                              Get.toNamed("/_detail_screen", arguments: {
                            "id": controller.toursites.value[itemIndex].id,
                            "name": controller.toursites.value[itemIndex].name,
                            "image":
                                controller.toursites.value[itemIndex].image,
                            "attractionType": controller
                                .toursites.value[itemIndex].atractionType,
                            "detail":
                                controller.toursites.value[itemIndex].detial,
                          }),
